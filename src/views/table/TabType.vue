    ...
    <el-container>
        <el-header height="40px">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>桌型管理</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        <el-main>
            <div class="tab-box">
                <div class="TabMinfo">
                    <el-button type="text" @click="dialogFormVisible = true">+添加桌型</el-button>

                    <el-dialog title="" :visible.sync="dialogFormVisible" :modal-append-to-body="false">
                        <el-form :model="form">
                            <el-form-item label="桌台类型" :label-width="formLabelWidth">
...
export default {
    ...
    created() {
        this.dataArr = this.$store.state.Table.tableType
    },
    methods: {
        handleClick() {
            ...
            this.$store.commit('Table/setType', this.dataArr)
            this.form.name = ''
        },
        edit(index) {
